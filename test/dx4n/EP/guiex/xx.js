...
atom("GuiexInternalSection1",regexp("[1-9][0-9]*")).beforeSeparator().afterSeparator();
atom("GuiexInternalSection2",regexp("[1-9][0-9]*\\.[1-9][0-9]*")).beforeSeparator().afterSeparator();
atom("GuiexInternalSection3",regexp("[1-9][0-9]*\\.[1-9][0-9]*\\.[1-9][0-9]*")).beforeSeparator().afterSeparator();
atom("GuiexInternalSection4",regexp("[1-9][0-9]*\\.[1-9][0-9]*\\.[1-9][0-9]*\\.[1-9][0-9]*")).beforeSeparator().afterSeparator();
