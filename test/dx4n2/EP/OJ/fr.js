...
atom("OJPrefix",regexp("(J\\.?O\\.?([ \xa0]OEB)?|Journal [Oo]fficiel([ \xa0](de l[’'])?OEB)?)[ \xa0]")).setGroup("OJ");
atom("OJPostfix",regexp("[ \xa0](JO([ \xa0]OEB)?|Journal [Oo]fficiel([ \xa0](de l[’'])?OEB)?)")).setGroup("OJ");
atom("OJInfix",regexp("[ \xa0](JO([ \xa0]OEB)?|Journal [Oo]fficiel([ \xa0](de l[’'])?OEB)?)[ \xa0]")).setGroup("OJ");
atom("OJ",regexp("(J\\.?O\\.?([ \xa0]OEB)?|Journal [Oo]fficiel([ \xa0](de l[’'])?OEB)?)")).setGroup("OJ");
atom("OJSupplementShortPrefix",regexp("(Suppl\\.([ \xa0]Publ\\.)?|Publ\\.[ \xa0][sS]uppl\\.)[ \xa0]"));
atom("OJSupplement",regexp("[sS]uppl[eé]ment|[Pp]ublication[ \xa0]supplémentaire"));
atom("OJSupplementPrefix",regexp("([sS]uppl[eé]ment|[Pp]ublication[ \xa0]supplémentaire)[ \xa0]"));
atom("OJSpecEdShortPrefix",regexp("[EÉé]d\\.[ \xa0]spéc(\\.|iale)[ \xa0]"));
atom("OJSpecEdPrefix",regexp("[EÉée]ditions?[ \xa0]spéciales?[ \xa0]"));
//atom("OJNumeroPrefix",regexp("([Nn][o°º]?\\.?)[ \xa0]?"));
atom("OJToPrefix",regexp("(au|à)[ \xa0]")).setGroup("OJTo");
atom("OJToInfix",regexp("[ \xa0](au|à)[ \xa0]")).setGroup("OJTo");;

atom("OJReplacementPage",regexp("[0-9]+>[0-9]+"));
/*
...
atom("OJYearPage",regexp("JO([ \xa0]OEB)?[ \xa0]([1-2][0-9]{3})[ \xa0]([1-9][0-9]+)")).issue("warning","comma missing");
