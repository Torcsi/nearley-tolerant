...
atom("OJPrefixStrange",regexp("(OJ|J\.O\.|Jo)([ \xa0](l')?OEB)?[ \xa0]")).setGroup("OJ").issue("warning","use JO instead");
atom("OJPrefixStrange2",regexp("JO[ \xa0]l'OEB[ \xa0]")).setGroup("OJ").issue("warning","use JO OEB instead");
